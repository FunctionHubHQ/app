...
export const RuntimeApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        runDevFunction: async (functionSlug: string, body: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionSlug' is not null or undefined
         ...
         * @throws {RequiredError}
         */
        runProdFunction: async (functionSlug: string, body: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionSlug' is not null or undefined
...
export const RuntimeApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async runDevFunction(functionSlug: string, body: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async runProdFunction(functionSlug: string, body: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
         ...
         * @throws {RequiredError}
         */
        async updateCode(code: Code, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CodeUpdateResult>> {
...
export class RuntimeApi extends BaseAPI {
     ...
     * @memberof RuntimeApi
     */
    public runDevFunction(functionSlug: string, body: string, options?: any) {
     ...
     * @memberof RuntimeApi
     */
    public runProdFunction(functionSlug: string, body: string, options?: any) {
...
export const SpecApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        getSpecStatus: async (statusRequest: StatusRequest, options: any = {}): Promise<RequestArgs> => {
         ...
         * @throws {RequiredError}
         */
        getUserSpec: async (functionSlug: string, version: string, authToken: string, env: string, options: any = {}): Promise<RequestArgs> => {
            // verify required parameter 'functionSlug' is not null or undefined
...
export const SpecApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getSpecStatus(statusRequest: StatusRequest, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<StatusResponse>> {
         ...
         * @throws {RequiredError}
         */
        async getUserSpec(functionSlug: string, version: string, authToken: string, env: string, options?: any): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<string>> {
...
export class SpecApi extends BaseAPI {
     ...
     * @memberof SpecApi
     */
    public getSpecStatus(statusRequest: StatusRequest, options?: any) {
     ...
     * @memberof SpecApi
     */
    public getUserSpec(functionSlug: string, version: string, authToken: string, env: string, options?: any) {
